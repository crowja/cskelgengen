...
Generates a subdirectory <name> with a C toolset development skeleton.
The codebase supports the creation of tools operating similar to Git
or Docker.

Options:
-h        Print this help message to stdout and exit.
-t <tag>  Use <tag> (instead of <name>) to prefix methods.
